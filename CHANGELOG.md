...
- This release adds source, documentation, and deterministic regression coverage.
  Prior installation and live acceptance belong to v0.2.0; no v0.2.1 installation
  or live target run is implied.
